class Api::V1::LotesController < ApplicationController
  ...
  private
    ...
    def lote_params
      params.require(:lote).permit(:cadastro_municipal, :endereco, :area, :frente, :lateral, :matricula, :vendido, :valor, :quadra, :numero_lote, :cartorio, :numero, :loteamento_id, :id)
    end
end
